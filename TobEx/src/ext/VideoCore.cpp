...
void (VidPal::*Tramp_VidPal_SetFxPaletteNo3d)(ARGB*, int, unsigned int, int, BOOL) =
	SetFP(static_cast<void (VidPal::*)(ARGB*, int, unsigned int, int, BOOL)>	(&VidPal::SetFxPaletteNo3d),	0x9F5897);

void DETOUR_VidPal::DETOUR_SetFxPaletteNo3d(ARGB* pPalette, int nBitsPerPixel, unsigned int dwFlags, int dwAlpha, BOOL bIgnoreBrighten) {
