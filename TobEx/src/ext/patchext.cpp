...
void InitPatches() {
	...
	if (pGameOptionsEx->GetOption("Action_AddKitFix")) {
		//AddKit()
	...
	if (pGameOptionsEx->GetOption("Action_AttackOnceFix") ||
		pGameOptionsEx->GetOption("Action_AttacksGenuine")) {
		...
		if (pGameOptionsEx->GetOption("Action_AttacksGenuine")) {
			//test eax,eax
	...
	if (pGameOptionsEx->GetOption("Action_ChangeAnimFix")) {
	...
	if (pGameOptionsEx->GetOption("Action_EquipRangedFix")) {
		//mov al,byte ptr ds:[edx]
	...
	if (pGameOptionsEx->GetOption("Action_JoinPartyFix")) {
		//push ecx
		//call
		char bytes[] = {0x51,
						0xE8};
	...
	if (pGameOptionsEx->GetOption("Action_TakePartyItemFix")) {
	...
	if (pGameOptionsEx->GetOption("Arenas_Enable")) {
		char bytes[] = {0x75};
	...
	if (pGameOptionsEx->GetOption("Debug_CriticalMsgBoxFix")) {
		//NOP, CALL
	...
	if (pGameOptionsEx->GetOption("Debug_LogMore")) {
		char bytes[] = {0x01};
	...
	if (pGameOptionsEx->GetOption("Debug_RestoreCombatInfoText")) {
	...
	if (pGameOptionsEx->GetOption("Eff_AwakenFix")) {
		char bytes[] = {0x27};
	...
	if (pGameOptionsEx->GetOption("Eff_CastingLevelModFix")) {
		//spelltype PRIEST
	...
	if (pGameOptionsEx->GetOption("Eff_DamageBypassMirrorImageConfig")) {
	...
	if (pGameOptionsEx->GetOption("Eff_ContainerUseEffFileFix")) {
	...
	if (pGameOptionsEx->GetOption("Eff_CureDrunkFix")) {
		char bytes[] = {0x5E};
	...
	if (pGameOptionsEx->GetOption("Eff_ForbidItemTypeFix")) {
	...
	if (pGameOptionsEx->GetOption("Eff_InvisibleFix")) {
	...
	if (pGameOptionsEx->GetOption("Eff_MirrorImageUseCastLevel")) {
	...
	if (pGameOptionsEx->GetOption("Eff_PolymorphFix")) {
	...
	if (pGameOptionsEx->GetOption("Engine_PriestKnownSpellsExtend")) {
		char bytes[] = {0x62};
	...
	if (pGameOptionsEx->GetOption("Engine_AllowZeroStartXP")) {
		char bytes[] = {0x8C};
	...
	if (pGameOptionsEx->GetOption("Engine_AllowDualClassAll")) {
		//nop a jnz
		char bytes[] = {0x90, 0x90};
	...
	if (pGameOptionsEx->GetOption("Engine_AssBHPenaltyKit")) {
	...
	if (pGameOptionsEx->GetOption("Engine_ClericRangerHLAFix")) {
	...
	if (pGameOptionsEx->GetOption("Engine_CustomSoAStartXP") != -1) {
		int nExp = pGameOptionsEx->GetOption("Engine_CustomSoAStartXP");
		char* bytes = (char*)&nExp;
		vDataList.push_back( Data(0xAB7258, 4, bytes) );
		vPatchList.push_back( Patch(vDataList) );
		vDataList.clear();
	}

	if (pGameOptionsEx->GetOption("Engine_CustomToBStartXP") != -1) {
		int nExp = pGameOptionsEx->GetOption("Engine_CustomToBStartXP");
		char* bytes = (char*)&nExp;
	...
	if (pGameOptionsEx->GetOption("Engine_DisableXPBoost")) {
	...
	if (pGameOptionsEx->GetOption("Engine_CharmSilenceRemoval")) {
		char bytes[] = {0xEB};
	...
	if (pGameOptionsEx->GetOption("Engine_RestSpawnsAdvanceTime")) {
	...
	if (pGameOptionsEx->GetOption("Engine_SummonLimitFix")) {
	...
	if (pGameOptionsEx->GetOption("Engine_TargetDeadFix")) {
	...
	if (pGameOptionsEx->GetOption("Engine_WeapSpecNumAttacksMod")) {
	...
	if (pGameOptionsEx->GetOption("Items_AbilityItemAnim")) {
	...
	if (pGameOptionsEx->GetOption("Items_BackstabRestrictionsConfig") ||
		pGameOptionsEx->GetOption("Eff_BackstabEveryHitConfig")) {
	...
	if (pGameOptionsEx->GetOption("Items_CriticalHitAversionConfig")) {
	...
	if (pGameOptionsEx->GetOption("Items_TargetInvisConfig")) {
	...
	//Expand RND*.2DA
	if (pGameOptionsEx->GetOption("Items_RandomTreasureExtend")) {
	...
	if (pGameOptionsEx->GetOption("Items_NonAmmoLauncherDamageFix")) {
		//mov ecx,dword ptr ss:[ebp+c]
		//push ecx
		//nop
	...
	if (pGameOptionsEx->GetOption("Sound_AnimSoundFix")) {
	...
	if (pGameOptionsEx->GetOption("Sound_DlgGreetingSubtitles")) {
	...
	if (pGameOptionsEx->GetOption("Spells_TargetInvisConfig")) {
		//mov edx,dword ptr ss:[ebp+8]
	...
	if (pGameOptionsEx->GetOption("Spells_ExternBardSong")) {
	...
	if (pGameOptionsEx->GetOption("Store_ItemRechargeMod")) {
	...
	if (pGameOptionsEx->GetOption("Trigger_KitFix")) {
		//push eax
	...
	if (pGameOptionsEx->GetOption("User_KitsExtend")) {
		//for count
	...
	if (pGameOptionsEx->GetOption("User_LargerTooltipScroll")) {
		char bytes[] = {0xE0};
	...
	if (pGameOptionsEx->GetOption("User_FourInventorySlots")) {
	...
	if (pGameOptionsEx->GetOption("Video_EnableMorePaperdolls")) {
	...
	if (pGameOptionsEx->GetOption("Video_IWDAnimAttack3Fix")) {
		//ASCII "2" -> "3" in "A2E"
		char bytes[] = {0x33};
	...
	if (pGameOptionsEx->GetOption("Video_SpellTurningAnimFix")) {
	...
	if (pGameOptionsEx->GetOption("Video_VvcAlphaCrashFix")) {
	...
	if (pGameOptionsEx->GetOption("Video_VvcShadowAnimFix")) {
