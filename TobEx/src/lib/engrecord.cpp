...
void (CRecord::*CRecord_UpdatePanel)(DWORD, CCreatureObject&) =
	SetFP(static_cast<void (CRecord::*)(DWORD, CCreatureObject&)>	(&CRecord::UpdatePanel),			0x6E93BD);
...
void CRecord::UpdatePanel(DWORD nPanelIdx, CCreatureObject& cre)	{ return (this->*CRecord_UpdatePanel)(nPanelIdx, cre); }
