...
WORD (CPtrListMessage::*CPtrListMessage_Send)(CMessage&, BOOL) =
	SetFP(static_cast<WORD (CPtrListMessage::*)(CMessage&, BOOL)>		(&CPtrListMessage::Send),		0x5B91FD);

WORD CPtrListMessage::Send(CMessage& msg, BOOL bForceAddToQueue) { return (this->*CPtrListMessage_Send)(msg, bForceAddToQueue); }CMessageAddAction::CMessageAddAction() { SetVT(this, 0xAA5BF4); }
...
CMessageSpriteUpdate::CMessageSpriteUpdate(CCreatureObject* pCre, Enum eSource, Enum eTarget) { (this->*CMessageSpriteUpdate_Construct)(pCre, eSource, eTarget); }
