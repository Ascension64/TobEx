...
ResRef* (ResRef::*ResRef_Construct_0)(void) =
	SetFP(static_cast<ResRef* (ResRef::*)(void)>			(&ResRef::Construct),		0x999EC1);
...
void (ResRef::*ResRef_NullSpaces)(void) =
	SetFP(static_cast<void (ResRef::*)(void)>				(&ResRef::NullSpaces),		0x999F6C);	
LPTSTR (ResRef::*ResRef_GetBuffer)(void) const =
	SetFP(static_cast<LPTSTR (ResRef::*)(void) const>		(&ResRef::GetBuffer),		0x999FB3);
IECString& (ResRef::*ResRef_SafeToString)(IECString&) =
	SetFP(static_cast<IECString& (ResRef::*)(IECString&)>		(&ResRef::SafeToString),	0x999FC1);
BOOL (ResRef::*ResRef_IsNotEmpty)(void) =
	SetFP(static_cast<BOOL (ResRef::*)(void)>				(&ResRef::IsNotEmpty),		0x99A040);
...
BOOL (ResRef::*ResRef_IsEmpty)(void) =
	SetFP(static_cast<BOOL (ResRef::*)(void)>				(&ResRef::IsEmpty),			0x99A3A0);
...
void (ResRef::*ResRef_ToUpper)(void) =
	SetFP(static_cast<void (ResRef::*)(void)>				(&ResRef::ToUpper),			0x99A634);
