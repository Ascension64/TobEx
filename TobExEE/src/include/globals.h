...
DefineGlobalFuncPtr(void*, __cdecl, _New, (size_t size), _NEW);
DefineGlobalFuncPtr(void, __cdecl, _Delete, (void* mem), _DELETE);
DefineGlobalFuncPtr(int, __cdecl, _Rand, (void), _RAND);
